...
public class PLAYGAME extends JPanel implements ActionListener {
    ...
    private ImageIcon play = new ImageIcon(this.getClass().getResource("Start.png"));
    private ImageIcon close = new ImageIcon(this.getClass().getResource("exit.png"));
    public int random = 0;
    public int score = 0;
        ...
        public void run() {
            while (true) {
                try {
                    ...
                    if (skyenemy.x - enemy.x < 500 && skyenemy.x == getWidth() ) {
                            if (score > 500) {
                                skyenemy.x = getWidth();
                                continue;
                            }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (playpause == true) {
            g.drawImage(pause.getImage(), 870, 10, 120, 90, this);
        } else if (playpause == false) {
            g.drawImage(play.getImage(), 900, 20, 170, 100, this);
        }
        if (charac.status == 0) {
        ...
        if (playpause == false) {
            g.drawImage(close.getImage(), 915, 80, 130, 90, this);
        }
