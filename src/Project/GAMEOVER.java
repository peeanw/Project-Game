...
public class GAMEOVER extends JPanel {
    private ImageIcon background = new ImageIcon(this.getClass().getResource("deadground.jpg"));
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawImage(restart.getImage(),260,220,470,290,this);
        ...
        g.drawString("SCORE : "+last,320,230);
    }
}